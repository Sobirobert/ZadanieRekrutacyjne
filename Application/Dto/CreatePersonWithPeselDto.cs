...
public class CreatePersonWithPeselDto(string Name, string Surname, string Pesel, string Street, string NumberOfHouse, string ZipCode, string City) 
    : IMap, IRepositoryObject
{
    ...
    {
        profile.CreateMap<CreatePersonWithPeselDto, WithPesel>();
    }
}
